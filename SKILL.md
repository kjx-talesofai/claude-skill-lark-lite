...
| 需求 | lark-cli 子命令 | 安装官方 Skill（可选） |
|:---|:---|:---|
| 收发消息、群聊、搜索聊天记录 | `lark-cli im ...` | `npx skills add larksuite/cli -g -s lark-im` |
| 创建/读取/编辑文档 | `lark-cli docs ...` | `npx skills add larksuite/cli -g -s lark-doc` |
| 多维表格操作 | `lark-cli base ...` | `npx skills add larksuite/cli -g -s lark-base` |
| 电子表格操作 | `lark-cli sheets ...` | `npx skills add larksuite/cli -g -s lark-sheets` |
| 文件上传下载 | `lark-cli drive ...` | `npx skills add larksuite/cli -g -s lark-drive` |
| 查看日程/创建日程 | `lark-cli calendar ...` | `npx skills add larksuite/cli -g -s lark-calendar` |
| 会议记录/妙记 | `lark-cli vc ...` / `lark-cli minutes ...` | `npx skills add larksuite/cli -g -s lark-vc` |
| 审批流程 | `lark-cli approval ...` | `npx skills add larksuite/cli -g -s lark-approval` |
| 知识库 | `lark-cli wiki ...` | `npx skills add larksuite/cli -g -s lark-wiki` |

> 需要更详细的命令和参数，直接运行 `lark-cli <子命令> --help`，或按需安装对应的官方 Skill。
